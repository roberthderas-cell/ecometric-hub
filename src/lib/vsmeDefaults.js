...
export const SECTIONS = [
  ...
  { id: 'c1', label: 'C1 — Strategia', icon: '🎯', group: 'MODULO COMPLETO' },
  { id: 'c2', label: 'C2 — Pratiche (det.)', icon: '📝', group: 'MODULO COMPLETO' },
  { id: 'c3', label: 'C3 — Target GHG', icon: '🌍', group: 'MODULO COMPLETO' },
  { id: 'c4', label: 'C4 — Rischi Climatici', icon: '🌊', group: 'MODULO COMPLETO' },
  { id: 'c5', label: 'C5 — Workforce+', icon: '📊', group: 'MODULO COMPLETO' },
  { id: 'c6', label: 'C6 — Diritti Umani', icon: '🤝', group: 'MODULO COMPLETO' },
  { id: 'c7', label: 'C7 — Incidenti DU', icon: '⚠️', group: 'MODULO COMPLETO' },
  { id: 'c8', label: 'C8 — Ricavi Settori', icon: '💼', group: 'MODULO COMPLETO' },
  { id: 'c9', label: 'C9 — Diversità CDA', icon: '🏛️', group: 'MODULO COMPLETO' },
