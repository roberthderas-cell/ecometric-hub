...
export const DEFAULT_DATA = {
  ana: { ragione: '', ateco: '', forma: 'SRL', anno: 2025, perimetro: 'individuale', paesi: 'Italia', attivo: '', fatturato: '', fte: '', hc: '', modulo: 'basic', cert: '', sede: '', dimManuale: '', sostPubblica: 'no', pctFattTassonomia: '', pctCapexTassonomia: '' },
  sedi: { lista: [] },
  en: { elReteN: '', elReteN1: '', elFVN: '', elFVN1: '', kWpFV: '', ispra: '0.211', annoIspra: '2023', scopeMetodo: 'location', goKWhN: '', goEFN: '0', classeEnergetica: '', targetGHG: 'no', targetGHGDesc: '', invRischioCC: '', assicRischioCC: '', noteEn: '' },
  ac: { scaricoN: '', scaricoN1: '', dipAcquaN: '', dipAcquaN1: '', ricN: '', ricN1: '', targetAcqua: 'no', targetAcquaDesc: '', noteAc: '' },
  ri: { totN: '', totN1: '', periN: '', periN1: '', recN: '', recN1: '', percRiciclatoProdotti: '', percRiciclabileImballaggi: '', noteRi: '', cerRows: [] },
  inq: { regol: 'no', noteInq: '' },
  biod: { supTot: '', supImp: '', natM2: '', sigillM2: '', noteBiod: '' },
  pe: { hc: '', hcN1: '', fte: '', fteN1: '', donne: '', donneN1: '', uomini: '', uominiN1: '', indet: '', det: '', pt: '', nd: '', infort: '0', ggPersi: '0', malProf: '0', decessi: '0', oreLav: '', assentGg: '', retMedia: '', retUom: '', retDon: '', oreForm: '', oreFormDonne: '', oreFormUomini: '', percVal: '', disab: '', salarioMin: '', ccnl: '', percCCNL: '', matN: '', promN: '', iniziativeFL: '', iniziativeCT: '', notePe: '' },
  gov: { compCDA: '', donneCDA: '', codEtico: 'no', mog231: 'no', iso14001: 'no', sa8000: 'no', iso45001: 'no', pariGen: 'no', policy: 'no', wb: 'no', rESG: 'no', cond: '0', san: '0', tempiPag: '', altreCert: '', sanAmb: '0', procSegnHS: 'no', noteGov: '' },
...
export const SECTIONS = [
  ...
  { id: 'b1', label: 'B1 — Basi di preparazione', icon: '📋', group: 'MODULO BASE', calc: true },
  { id: 'b2', label: 'B2 — Pratiche e Politiche', icon: '📌', group: 'MODULO BASE', calc: true },
  ...
  { id: 'b11', label: 'B11 — Corruzione', icon: '🔒', group: 'MODULO BASE', calc: true },
  ...
  { id: 'obiettivi', label: '🎯 Obiettivi ESG', icon: '🎯', group: 'OUTPUT' },
