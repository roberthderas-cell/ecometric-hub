...
export default function SectionAcqua({ data, onUpdate, onNavigate }) {
  ...
  return (
    <div>
      <SectionHeader icon="💧" title="B6 — Acqua" description="Prelievi idrici per fonte, scarichi, consumo netto e KPI per dipendente." reference="VSME B6 | Prelievo, stress idrico, consumo" />
