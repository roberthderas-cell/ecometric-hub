      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-5">
        <Card className="p-5">
          ...
          <ResponsiveContainer width="100%" height={160}>
            <BarChart data={ghgData}><XAxis dataKey="name" fontSize={11} /><YAxis fontSize={10} /><Tooltip /><Bar dataKey="value" radius={[6,6,0,0]}>{ghgData.map((d,i) => <Cell key={i} fill={d.fill} />)}</Bar></BarChart>
          </ResponsiveContainer>
        </Card>
        <Card className="p-5">
